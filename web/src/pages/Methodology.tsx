  ...
  return (
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="bg-white p-8 rounded-3xl border border-emerald-100 shadow-sm">
        ...
        <h1 className="text-3xl font-black text-emerald-900 mb-6 tracking-tight">Metodologi & Rapor Model</h1>
        
        <div className="prose prose-nawa max-w-none prose-headings:font-bold prose-nawa">
          ...
          <div className="my-10 bg-emerald-50 p-6 rounded-2xl border border-emerald-200">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm text-emerald-700">
                <thead className="text-xs text-emerald-500 uppercase tracking-wider bg-emerald-100/50">
                  <tr>
                ...
                <tbody className="divide-y divide-emerald-100">
                  <tr className="hover:bg-emerald-50 transition-colors">
                    <td className="px-4 py-4 font-semibold text-emerald-900">Cabai Rawit Merah</td>
                    <td className="px-4 py-4 text-emerald-500">7 Hari</td>
                    <td className="px-4 py-4 font-bold text-emerald-600">0.988</td>
                    <td className="px-4 py-4">77.4% <span className="text-xs text-emerald-400 ml-1">(Target 80%)</span></td>
                  </tr>
                  <tr className="hover:bg-emerald-50 transition-colors">
                    <td className="px-4 py-4 font-semibold text-emerald-900">Cabai Rawit Merah</td>
                    <td className="px-4 py-4 text-emerald-500">14 Hari</td>
                  ...
                  <tr className="hover:bg-emerald-50 transition-colors bg-red-50/30">
                    <td className="px-4 py-4 font-semibold text-emerald-900">Cabai Rawit Hijau</td>
                    <td className="px-4 py-4 text-emerald-500">7 Hari</td>
            ...
            <p className="text-xs text-emerald-500 mt-4 italic">
          ...
          <h3 className="text-2xl font-bold text-emerald-800 mt-8 mb-4">Penanganan Data & Imputasi</h3>
